            ...
            {!capsules ? (
                ...
                <section className='py-32'>
                    ...
                    <div className='max-width grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 px-5'>
                        {capsules.map(({
                            id,type,status, serial, launches, last_update, land_landings, water_landings, reuse_count
                        }) => (
                            <article key={id} className="articles">
                                ...
                                <ul>
                                    ...
                                    <li className='mb-1'>{land_landings} landings</li>
                                    <li className='mb-1'>{water_landings} landings</li>
                                    <li className='mb-1'> Reused {reuse_count} times</li>
                                    {status === "active" ? (
                                        <li className='text-emerald-500'>Active</li>
                                    ) : (
                                        <li className='text-red-500'>Retired</li>
                                    )}
                                </ul>
